  ...
  return (
    <>
      <div className="h-[calc(100vh-80px)] flex items-start justify-center bg-secondary">
        <div className="max-w-2xl w-full h-full bg-white border-2 border-primary rounded-lg shadow-lg flex flex-col items-center justify-start pt-5 lg:h-4/5 lg:w-4/5 lg:mt-5">
          ...
          <div className="w-4/5 bg-blue-50 rounded-lg flex items-center justify-center p-4 mb-5 shadow-sm">
            <label
              htmlFor="subject"
              className="text-lg font-semibold text-color-primary mr-6"
            >
              1. Choose a Subject:
            </label>
            <select
          ...
          <div className="w-4/5 bg-blue-50 rounded-lg flex items-center justify-center p-4 mb-5 shadow-sm">
            <label
              htmlFor="class"
              className="text-lg font-semibold text-blue-800 mr-6"
            >
              2. Choose a Class for Quiz:
            </label>
            <select
              id="class"
              value={selectedClass}
