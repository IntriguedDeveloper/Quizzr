...
export default function ClassCard({
	...
	return (
		<div
			className={`w-3/5 h-32 lg:h-40 lg:w-64 bg-white rounded-lg shadow-lg border border-gray-300 flex flex-col items-center justify-center p-6 space-y-3 transition-transform duration-300 hover:cursor-pointer ${
				isLoading
